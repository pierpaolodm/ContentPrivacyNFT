...
var OptimisedMT = /** @class */ (function () {
    ...
    OptimisedMT.unserialize = function (s) {
        var d = unstringifyBigInts(JSON.parse(s));
        var tree = new OptimisedMT(d.depth, d.zeroValue, d.leavesPerNode, circomlibjs_1.poseidon);
        tree.root = d.root;
